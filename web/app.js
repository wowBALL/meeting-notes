...
const UI = {
  th: {
    ...
    models: [
      ...
      ["litellm/gemma4", "gemma4 (ทดลอง)", "ข้อมูลไม่ออกนอกบริษัท · สรุปหายกลางทางกับประชุมยาว"],
  ...
  en: {
    ...
    models: [
      ...
      ["litellm/gemma4", "gemma4 (experimental)", "Stays in-house · drops content on long meetings"],
