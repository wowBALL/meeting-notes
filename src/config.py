...
class Config:
    ...
    # โปรเซสข้างเคียงที่สั่งเปิดเองด้วย POST /api/companion/start เท่านั้น (ไม่เปิดอัตโนมัติ
    # ตอนเริ่มอัดอีกต่อไป) แล้วถูกปิดอัตโนมัติตอนเข้าขั้น encode ลิสต์ว่าง = ปิดฟีเจอร์
    # ซึ่งเป็นดีฟอลต์ -- เครื่องที่ไม่ตั้งค่านี้ต้องได้พฤติกรรมเดิมทุกอย่าง
    #
