...
**`teams.md` ถูก gitignore ไว้แล้ว** เพราะมีชื่อคนจริงและ repo นี้เป็น public ส่วน `glossary.md` commit ได้เพราะเป็นศัพท์เทคนิคล้วน — **ถ้าจะใส่ชื่อลูกค้าหรือชื่อระบบภายในลง `glossary.md` ให้เพิ่มเข้า `.gitignore` ก่อน**
