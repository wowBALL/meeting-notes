...
โปรเซสนี้**ไม่ได้ถูกเปิดอัตโนมัติตอนเริ่มอัด** ต้องสั่งเปิดด้วย `POST /api/companion/start`
...
จังหวะปิดอัตโนมัติเลือกไว้ที่**ขั้นแปลงไฟล์** (ไม่ใช่ตอนแปลงเสร็จ) เพื่อให้ทรัพยากรระดับเครื่องที่โปรแกรมนั้นถืออยู่ เช่นหน่วยความจำการ์ดจอ ถูกคืนทันก่อนขั้นถอดเสียงจะขอใช้ วัดจากประชุมจริงพบว่าช่วงแปลงไฟล์กว้าง 62–69 วินาที ส่วนช่วงหลังแปลงเสร็จถึงงานถัดไปมีแค่ราว 2 วินาที
